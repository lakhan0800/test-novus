  ...
  const save = useCallback(async () => {
    ...
    try {
      ...
      pendo?.track("quick_add_transaction_saved", {
        ...
        amount: parsed.amount,
        categoryId: effectiveCategory.id,
        categoryWasOverridden: overrideCategory !== null,
        categoryWasGuessed: parsed.categoryGuessed,
        descriptionLength: (parsed.description || effectiveCategory.name)
          .length,
        dateWasExplicit: parsed.dateExplicit,
      });
